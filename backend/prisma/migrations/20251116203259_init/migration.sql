-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('PROVIDER', 'CONSUMER');
...
-- AddForeignKey
ALTER TABLE "bookings" ADD CONSTRAINT "bookings_consumerId_fkey" FOREIGN KEY ("consumerId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
